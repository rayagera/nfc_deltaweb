			...
			<div class="row">
				<div class="col-sm-6 col-md-4 col-md-offset-4">					
					...
					<div class="account-wall">
						...
						<form name="myForm" class="form-signin" role="form" action='step2.php' novalidate>   
							 <h3>Step 1: Fill Account</h3>
			                  ...
			                  <span style="color:red" ng-show="invalideAccount">
			                    	<span>Account or Email is invalid.</span>
			                  </span>
			                  <span class="clearfix"></span>
			                  <p>   
			                  		<a class="btn btn-primary btn-primary" role="button" ng-click='findAccount()'>Next Step</a>

			                  		<input class="btn btn-primary" type="submit" value="Next Step" ng-click='findAccount()' />
			                  </p>
			            </form>
					</div>
				</div>
